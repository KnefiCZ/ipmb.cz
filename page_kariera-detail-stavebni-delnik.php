        ...
        <?php $barva=2; include_once ('part_logo.php'); ?>
            <div class="row justify-content-center py-3 g-4 box-card">
                ...
                <div class="col-12 col-md-5">
                    ...
                    <div data-fancybox="gallery1" data-src="/images/kariera-03.jpg" data-caption="Stavební dělník - ipmb.cz" data-gallery="Stavební dělník" class="gallery__content">
                        
                        <img class="img-fluid img-style gallery__img" src="/images/kariera-03.jpg" alt="Stavební dělník">
                ...
                <div class="col-12 col-md-7 ps-lg-5">
                    ...
                    <h1 class="h-1 h-1--dark pb-2" style="z-index: 1;">Stavební dělník</h1>
            ...
            <div class="row justify-content-center g-3 py-3">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div data-fancybox="gallery1" data-src="/images/kariera-detail-07.jpg" data-caption="Stavební dělník - ipmb.cz" data-gallery="Stavební dělník" class="gallery__content">
                        <img class="img-fluid img-style gallery__img" src="/images/kariera-detail-07.jpg" alt="Stavební dělník">
                    </div>
                </div>

                <div class="col-sm-6 col-lg-4">
                    <div data-fancybox="gallery1" data-src="/images/kariera-detail-08.jpg" data-caption="Stavební dělník - ipmb.cz" data-gallery="Stavební dělník" class="gallery__content">
                        <img class="img-fluid img-style gallery__img" src="/images/kariera-detail-08.jpg" alt="Stavební dělník">
                    </div>
                </div>

                <div class="col-sm-6 col-lg-4">
                    <div data-fancybox="gallery1" data-src="/images/kariera-detail-09.jpg" data-caption="Stavební dělník - ipmb.cz" data-gallery="Stavební dělník" class="gallery__content">
                        <img class="img-fluid img-style gallery__img" src="/images/kariera-detail-09.jpg" alt="Stavební dělník">
                    </div>
                </div> 
            ...
            <div class="row gy-3 g-sm-3 pt-5 px-1">
                ...
                <h2 class="h-2 mt-5 mb-3">Ideální vlastnosti stavebního dělníka</h2>
            ...
            <div class="row gy-3 g-sm-3 py-5 px-1">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="tag active">
                        <p class="tag__text">Čistou mzdu 22–26 000 Kč</p>
                    </div>
                </div>
...
mám zájem o nabízenou pozici stavebního dělníka.
