...
$predmet = "Zpráva z webových stránek"; //Za předmět emailu se automaticky dopisuje doména a časové razítko přijetí emailu
...
if(isset($_POST['zprava'])) {$zprava = $_POST['zprava'];} else{$zprava="";}
